  ...
  serveMagicHtml(req, res, next) {
    this.middleware.waitUntilValid(() => {
      ...
      try {
        ...
        const responsePage = `<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body><script type="module" charset="utf-8" src="${_path}.${extension}${queries}"></script></body></html>`;
